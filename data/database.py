"""
PostgreSQL database layer — schema, inserts, and query helpers.
Public API is identical to the previous SQLite version.
"""
...
def get_connection():
    ...
    # Required for Supabase connection pooler (Supavisor transaction mode)
